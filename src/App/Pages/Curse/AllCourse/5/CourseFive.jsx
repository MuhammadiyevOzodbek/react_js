...
function CourseFive() {
    ...
    useEffect(() => {
        const savedComments = JSON.parse(localStorage.getItem("comen"))
        if (savedComments) {
    ...
    const addComments = () => {
        if (comment.trim() !== "") {
            ...
            localStorage.setItem("comen", JSON.stringify(newComments))
            setComment("")
        }
    }
        ...
        <div className='id-all'>
            ...
            <div className="id-three">
                ...
                <div className="id-three-3">
                    ...
                    <h1>Node.js dasturchi kursida siz quyidagilarni o'rganasiz!</h1>
                    {data1.map((item, id) => (
